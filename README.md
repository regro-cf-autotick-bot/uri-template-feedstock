...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uri-template-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14728&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/uri-template-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uri-template` can be installed with:

```
conda install uri-template
```

It is possible to list all of the versions of `uri-template` available on your platform with:
